          ...
          <ScrollReveal delay={150}>
            <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-12 md:gap-24">
              ...
              <div className="flex flex-col space-y-6 text-left">
                ...
                <a href="https://wa.me/528119784678" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group w-fit">
                  ...
                  <span className="font-times italic text-2xl md:text-3xl text-foreground group-hover:text-primary transition-colors hover-underline w-fit py-0.5">+52 (81) 1978 4678</span>
                </a>
              </div>
